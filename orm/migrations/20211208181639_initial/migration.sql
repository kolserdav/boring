...
CREATE TABLE `EventCategory` (
    ...
    UNIQUE INDEX `EventCategory_eventId_categoryId_key`(`eventId`, `categoryId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Favorites` (
    ...
    UNIQUE INDEX `Favorites_eventId_userId_key`(`eventId`, `userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Image` (
    ...
    `origin` ENUM('category', 'event', 'icon', 'icon_sub') NOT NULL,
