  ...
  */
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof CategoryCountOutputType
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof EventCountOutputType
            ? EventCountOutputType[P]
            : never;
        }
      : EventCountOutputType
    : EventCountOutputType;
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    Category<T extends CategoryFindManyArgs = {}>(
      args?: Subset<T, CategoryFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Category>>, PrismaPromise<Array<CategoryGetPayload<T>>>>;

    UserCategory<T extends UserCategoryFindManyArgs = {}>(
      args?: Subset<T, UserCategoryFindManyArgs>
    ): CheckSelect<
      T,
      PrismaPromise<Array<UserCategory>>,
      PrismaPromise<Array<UserCategoryGetPayload<T>>>
    >;

    Event<T extends EventFindManyArgs = {}>(
      args?: Subset<T, EventFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Event>>, PrismaPromise<Array<EventGetPayload<T>>>>;

    Favorites<T extends FavoritesFindManyArgs = {}>(
      args?: Subset<T, FavoritesFindManyArgs>
    ): CheckSelect<
      T,
      PrismaPromise<Array<Favorites>>,
      PrismaPromise<Array<FavoritesGetPayload<T>>>
    >;
    ...
    ? 'include' extends U
      ? Category & {
          [P in TrueKeys<S['include']>]: P extends 'User'
            ...
            ? Array<UserCategoryGetPayload<S['include'][P]>>
            : P extends '_count'
            ? CategoryCountOutputTypeGetPayload<S['include'][P]> | null
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof Category
            ? Category[P]
            : P extends 'User'
            ...
            ? Array<UserCategoryGetPayload<S['select'][P]>>
            : P extends '_count'
            ? CategoryCountOutputTypeGetPayload<S['select'][P]> | null
            : never;
        }
      : Category
    : Category;
  ...
  export interface CategoryDelegate<GlobalRejectSettings> {
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Category'> extends True
      ? CheckSelect<
          T,
          Prisma__CategoryClient<Category>,
          Prisma__CategoryClient<CategoryGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__CategoryClient<Category | null>,
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Category'> extends True
      ? CheckSelect<
          T,
          Prisma__CategoryClient<Category>,
          Prisma__CategoryClient<CategoryGetPayload<T>>
    ...
    ): {} extends InputErrors ? GetCategoryGroupByPayload<T> : Promise<InputErrors>;
  }
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof UserCategory
            ? UserCategory[P]
            : P extends 'User'
  ...
  export interface UserCategoryDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends UserCategoryFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__UserCategoryClient<UserCategory>,
          Prisma__UserCategoryClient<UserCategoryGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__UserCategoryClient<UserCategory | null>,
          Prisma__UserCategoryClient<UserCategoryGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends UserCategoryFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
     ...
     * })
     **/
    aggregate<T extends UserCategoryAggregateArgs>(
      args: Subset<T, UserCategoryAggregateArgs>
    ): PrismaPromise<GetUserCategoryAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, UserCategoryGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors ? GetUserCategoryGroupByPayload<T> : Promise<InputErrors>;
  }
    ...
    ? 'include' extends U
      ? Event & {
          [P in TrueKeys<S['include']>]: P extends 'User'
            ...
            ? Array<FavoritesGetPayload<S['include'][P]>>
            : P extends '_count'
            ? EventCountOutputTypeGetPayload<S['include'][P]> | null
            : never;
        }
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof Event
            ...
            ? Array<FavoritesGetPayload<S['select'][P]>>
            : P extends '_count'
            ? EventCountOutputTypeGetPayload<S['select'][P]> | null
            : never;
        }
      : Event
    : Event;
  ...
  export interface EventDelegate<GlobalRejectSettings> {
    ...
    ): {} extends InputErrors ? GetEventGroupByPayload<T> : Promise<InputErrors>;
  }
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof Favorites
            ? Favorites[P]
            : P extends 'User'
            ? UserGetPayload<S['select'][P]>
            : P extends 'Event'
  ...
  export interface FavoritesDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends FavoritesFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
      args: SelectSubset<T, FavoritesFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Favorites'> extends True
      ? CheckSelect<
          T,
          Prisma__FavoritesClient<Favorites>,
          Prisma__FavoritesClient<FavoritesGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__FavoritesClient<Favorites | null>,
          Prisma__FavoritesClient<FavoritesGetPayload<T> | null>
        >;
     ...
     **/
    findFirst<
      T extends FavoritesFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
      args?: SelectSubset<T, FavoritesFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Favorites'> extends True
      ? CheckSelect<
          T,
          Prisma__FavoritesClient<Favorites>,
          Prisma__FavoritesClient<FavoritesGetPayload<T>>
    ...
    aggregate<T extends FavoritesAggregateArgs>(
      args: Subset<T, FavoritesAggregateArgs>
    ): PrismaPromise<GetFavoritesAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, FavoritesGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors ? GetFavoritesGroupByPayload<T> : Promise<InputErrors>;
  }
  ...
  export type UserCategoryScalarFieldEnum =
    typeof UserCategoryScalarFieldEnum[keyof typeof UserCategoryScalarFieldEnum];
  ...
  export type FavoritesScalarFieldEnum =
    typeof FavoritesScalarFieldEnum[keyof typeof FavoritesScalarFieldEnum];
  ...
  export type CategoryCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<CategoryCreateWithoutUserInput>,
      Enumerable<CategoryUncheckedCreateWithoutUserInput>
    >;
  ...
  export type UserCategoryCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<UserCategoryCreateWithoutUserInput>,
      Enumerable<UserCategoryUncheckedCreateWithoutUserInput>
    >;
  ...
  export type EventCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<EventCreateWithoutUserInput>,
      Enumerable<EventUncheckedCreateWithoutUserInput>
    >;
  ...
  export type FavoritesCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<FavoritesCreateWithoutUserInput>,
      Enumerable<FavoritesUncheckedCreateWithoutUserInput>
    >;
  ...
  export type UserCategoryCreateNestedManyWithoutCategoryInput = {
    create?: XOR<
      Enumerable<UserCategoryCreateWithoutCategoryInput>,
      Enumerable<UserCategoryUncheckedCreateWithoutCategoryInput>
    >;
  ...
  export type CategoryCreateNestedOneWithoutUserCategoryInput = {
    create?: XOR<
      CategoryCreateWithoutUserCategoryInput,
      CategoryUncheckedCreateWithoutUserCategoryInput
    >;
  ...
  export type CategoryUpdateOneRequiredWithoutUserCategoryInput = {
    ...
    connect?: CategoryWhereUniqueInput;
    update?: XOR<
      CategoryUpdateWithoutUserCategoryInput,
      CategoryUncheckedUpdateWithoutUserCategoryInput
    >;
  };
  ...
  export type FavoritesCreateNestedManyWithoutEventInput = {
    create?: XOR<
      Enumerable<FavoritesCreateWithoutEventInput>,
      Enumerable<FavoritesUncheckedCreateWithoutEventInput>
    >;
  ...
  export type UserCategoryUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      UserCategoryUpdateManyMutationInput,
      UserCategoryUncheckedUpdateManyWithoutUserCategoryInput
    >;
  };
  ...
  export type UserCategoryCreateOrConnectWithoutCategoryInput = {
    ...
    create: XOR<
      ...
      UserCategoryUncheckedCreateWithoutCategoryInput
    >;
  };
  ...
  export type UserCategoryUpsertWithWhereUniqueWithoutCategoryInput = {
    where: UserCategoryWhereUniqueInput;
    update: XOR<
      UserCategoryUpdateWithoutCategoryInput,
      UserCategoryUncheckedUpdateWithoutCategoryInput
    >;
    create: XOR<
      UserCategoryCreateWithoutCategoryInput,
      UserCategoryUncheckedCreateWithoutCategoryInput
